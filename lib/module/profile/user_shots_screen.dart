...
class UsersShotScreen extends StatefulWidget {
  String? user_id;
  UsersShotScreen({
    required this.user_id,
  });
  @override
  State<UsersShotScreen> createState() => _UsersShotScreenState();
}

class _UsersShotScreenState extends State<UsersShotScreen> implements FeedInterface,ProfileInterface {
  DateTime? dateTime;
  ...
  Widget build(BuildContext context) {
    ...
    return kIsWeb? SingleChildScrollView(
      child: userShotsWidget(),
    ):userShotsWidgetMobile();
  }

  Widget userShotsWidget(){
                                  ...
                                  return Column(
                                    ...
                                    children: [
                                        ...
                                        children: [
                                          ...
                                          Column(
                                            children: [
                                                ...
                                                children: [
                                                  ...
                                                  GestureDetector(
                                                    ...
                                                    child: Theme(
                                                      ...
                                                      child: SessionManager.getString(Preferences.USER_ID) ==  userData!.posts![index]!.userId.toString()
                                                          ? PopupMenuButton(
                                                          ...
                                                          itemBuilder: (ctx) => [
                                                            _buildPopupMenuItem(UtilStrings.Edit, () async {
                                                              setState(() {
                                                                ...
                                                                postType = 1;
                                                                editType = 1;
                                                                takefloorController.text =  userData!.posts![index].caption.toString();
                                                                postID =  userData!.posts![index].postContents![0].postId!.toString();
                                                                postMediaUrl= userData!.posts![index].postContents![0].mediaUrl!.toString();
                                                              });
                                                              getTagUsers( userData!.posts![index].postContents![0].postId!);
                                                            ...
                                                            _buildPopupMenuItem(UtilStrings.Delete, () {
                                                              setState(() {});
                                                              showAlertDialog(context, "Delete Shot", "Are you sure you want to Delete this Shot?",  userData!.posts![index]!.postContents![0].postId!.toInt(), 2,  userData!.posts![index]!.userId.toString());
                                                            }),
                                                            _buildPopupMenuItem(UtilStrings.Hide_Shot, () {
                                                              setState(() {
                                                                //filterType=2;
                                                              });
                                                              showAlertDialog(context, "Hide Shot", "Are you sure you want to Hide this Shot?",  userData!.posts![index]!.postContents![0].postId!.toInt(), 3,  userData!.posts![index]!.userId.toString());
                                                            }),
                                                          ])
                                                          : PopupMenuButton(
                                                          shape: const RoundedRectangleBorder(
                                                          ...
                                                          itemBuilder: (ctx) => [
                                                            _buildPopupMenuItem(UtilStrings.Block, () {
                                                              setState(() {});
                                                              showAlertDialog(context, "Block User", "Are you sure you want to block user?",  userData!.posts![index]!.postContents![0].postId!.toInt(), 1,userData!.id.toString());
                                                            }),
                                                            _buildPopupMenuItem(UtilStrings.Report, () {
                                                              setState(() {
                                                                postID = userData!.posts![index]!.postContents![0].postId!.toString();
                                                              });
                                                              showReportDialog(context, reportController, userData!.posts![index]!.postContents![0].postId!.toInt(), userData!.posts![index]!.userId!);
                                                            }),
                                                          ]),
                                                    ),
                                                  ),
                                              ...
                                              Row(
                                                children: [
                                                  Utils.mediumHeadingNormalText(text: Utils.convertDate(userData!.posts![index].postContents![0].createdAt.toString() /*+" at "+Utils.convertDateTime(allPosts[index].postContents![0].createdAt.toString())*/), textSize: 10, fontWeight: FontWeight.normal, color: HexColor("#7B7F91")),
                                                ],
                                              ),
                                            ],
                                          )
                                      ...
                                      Utils.mediumHeadingNormalText(
                                          text: userData!.posts![index]!.caption,
                                          textSize:
                                          12,
                                          color: AppColor
                                              .APP_TEXT_COLOR,
                                      ...
                                      userData!.posts![index]!.postContents![0].mediaUrl.toString().contains(".mp4") ||userData!.posts![index]!.postContents![0].mediaUrl.toString().contains(".mov")?
                                      Container(
                                        height:Responsive().getResponsiveValue(
                                            forLargeScreen:  size.height / 1.8,
                                            forMediumScreen: size.height / 1.6,
                                            forMobLandScapeMode: size.height / 1.6,
                                            forShortScreen: size.height / 1.6,
                                            forTabletScreen: size.height / 1.6,
                                            context: context),
                                        width: size
                                            .width,
                                        child:  VideoPlayerApp(
                                          IMAGE_URL +userData!.posts![index]!.postContents![0].mediaUrl.toString(),"mp4",
                                        ),
                                      )
                                          :GestureDetector(
                                        onTap: (){
                                          Utils.viewPhoto(context, IMAGE_URL + userData!.posts![index]!.postContents![0].mediaUrl.toString());
                                        },
                                        child:Container(
                                          height:Responsive().getResponsiveValue(
                                          ...
                                          decoration: BoxDecoration(
                                              image: DecorationImage(
                                                image: NetworkImage(IMAGE_URL + userData!.posts![index]!.postContents![0].mediaUrl.toString()),
                                                fit: Responsive().getResponsiveValue(
                                                    forLargeScreen: BoxFit.contain,
                                        ...
                                        children: [
                                              ...
                                              Row(
                                                children: [
                                                  ...
                                                  GestureDetector(
                                                    onTap: () {
                                                      setState(() {
                                                        feedPresenter?.doLikePost(userData!.posts![index]!.postContents![0].postId.toString(), true, "1");
                                                      });
                                                    },
                                                    child: userData!.posts![index]!.postContents![0].currentUserLikeByHeart != "1"
                                                        ? const Image(
                                                  ...
                                                  GestureDetector(
                                                      onTap: () {
                                                        setState(() {
                                                          ...
                                                          postDate = userData!.createdAt.toString();
                                                          postID = userData!.posts![index]!.postContents![0].id.toString();
                                                          userProfile = userData!.userImagesWhileSignup!.isNotEmpty ? userData!.userImagesWhileSignup![0].imageUrl.toString() : "";
                                                        });
                                                        if (userData!.posts![index]!.postContents![0].totalLikeByHeart.toString() == "0") {
                                                        } else {
                                                          getLikePost(userData!.posts![index]!.postContents![0].postId!.toInt(),"1");
                                                        }
                                                      },
                                                      child: Utils.mediumHeadingNormalText(text: " ${userData!.posts![index]!.postContents![0].totalLikeByHeart}", textSize: 10, color: HexColor("#7B7F91"))),
                                                  VerticalDivider(
                                                  ...
                                                  GestureDetector(
                                                    onTap: () {
                                                      setState(() {
                                                        feedPresenter?.doLikePost(userData!.posts![index]!.postContents![0].postId!.toString(), true, "0");
                                                      });
                                                    },
                                                    child: userData!.posts![index]!.postContents![0].currentUserLikeByThumb == "1"
                                                        ? const Image(
                                                  ...
                                                  GestureDetector(
                                                      onTap: (){
                                                        setState(() {
                                                          userName = userData!.name.toString();
                                                          postDate = userData!.createdAt.toString();
                                                          postID = userData!.posts![index].id.toString();
                                                          userProfile = userData!.userImagesWhileSignup!.isNotEmpty ? userData!.userImagesWhileSignup![0].imageUrl.toString() : "";
                                                        });
                                                        if (userData!.posts![index].postContents![0].totalLikeByThumb.toString() == "0") {
                                                        } else {
                                                          getLikePost(userData!.posts![index]!.postContents![0].postId!.toInt(),"0");
                                                        }
                                                      },
                                                      child: Utils.mediumHeadingNormalText(text: " ${userData!.posts![index].postContents![0].totalLikeByThumb}", textSize: 10, color: HexColor("#7B7F91"))),
                                                  VerticalDivider(
                                                    color: HexColor("#E2E2E2"),
                                                    thickness: 1,
                                                  ),
                                                  GestureDetector(
                                                    onTap: () {
                                                      setState(() {
                                                        feedPresenter?.doLikePost(userData!.posts![index]!.postContents![0].postId.toString(), true, "2");
                                                      });
                                                    },
                                                    child: userData!.posts![index].postContents![0]!.currentUserLikeByStar != "1"
                                                        ? const Image(
                                                  ...
                                                  GestureDetector(
                                                    onTap: () {
                                                      ...
                                                      if (userData!.posts![index]!.postContents![0].totalLikeByStar.toString() == "0") {
                                                      } else {
                                                        getLikePost(userData!.posts![index]!.postContents![0].postId!.toInt(),"2");
                                                      }
                                                    },
                                                    child: Utils.mediumHeadingNormalText(text: " ${userData!.posts![index]!.postContents![0].totalLikeByStar}", textSize: 10, color: HexColor("#7B7F91")),
                                                  ),
                                                  Gap(4),
                                                ],
                                              ),
                                          ...
                                          GestureDetector(
                                            onTap:
                                              ...
                                              setState(() {
                                                ...
                                                postDate = userData!.createdAt.toString();
                                                postID = userData!.posts![index].id.toString();
                                                userProfile = userData!.userImagesWhileSignup!.isNotEmpty ?
                                                userData!.userImagesWhileSignup![0].imageUrl.toString() : "";
                                              });
                                              getcommentPost(userData!.posts![index]!.postContents![0].postId!.toString());
                                            },
                                            child: Container(
                                                height: 33,
                                                decoration: BoxDecoration(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    const Gap(4),
                                                    Utils.mediumHeadingNormalText(text: userData!.posts![index]!.postContents![0].totalCommentOnThisPost.toString() + " Comments", textSize: 10, color: HexColor("#7B7F91")),
                                                    const Gap(8),
                                                  ],
                                                )),
                                          ),
                                          GestureDetector(
                                            onTap: () {
                                              ...
                                              if (userData!.posts![index]!.postContents![0].totalTagsOnThisPost.toString() != "0") {
                                                setState(() {
                                                  postID = userData!.posts![index]!.postContents![0].postId!.toString();
                                                });
                                            ...
                                            child: Container(
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    const Gap(4),
                                                    Utils.mediumHeadingNormalText(text:"${userData!.posts![index]!.postContents![0].totalTagsOnThisPost} Tags", textSize: 10, color: HexColor("#7B7F91")),
                                                    const Gap(6),
                                                    Image.asset(
      ...
      children: [
        Container(
         /* width: size.width,
          ...
          child: userData!=null
              ? userData!.posts!.isNotEmpty?Container(
            padding:
                                  ...
                                  children: [
                                    ...
                                    GestureDetector(
                                      onTap: () {
                                        ...
                                        setState(() {
                                          if(userData!.posts![index].postContents![0].currentUserLikeByHeart=="1"){
                                            userData!.posts![index].postContents![0].currentUserLikeByHeart="0";
                                            feedPresenter?.doLikePost(userData!.posts![index].id.toString(), false, "1");
                                          }else{
                                            userData!.posts![index].postContents![0].currentUserLikeByHeart="1";
                                            userData!.posts![index].postContents![0].currentUserLikeByThumb="0";
                                            userData!.posts![index].postContents![0].currentUserLikeByStar="0";
                                            feedPresenter?.doLikePost( userData!.posts![index]!.id.toString(), true, "1");
                                          }
                                        });
                                      },
                                      child:  userData!.posts![index]!.postContents![0].currentUserLikeByHeart == "0"
                                          ? const Image(
                                        image: AssetImage("assets/images/icon_likes.png"),
                                        height: 14,
                                        width: 14,
                                    ...
                                    GestureDetector(
                                        onTap: () {
                                          setState(() {
                                            ...
                                            postDate = userData!.createdAt.toString();
                                            postID =  userData!.posts![index]!.postContents![0].postId.toString();
                                            // userProfile =  userData!.posts![index]!!.user!.userImagesWhileSignup!.isNotEmpty ?  userData!.posts![index]!!.user!.userImagesWhileSignup![0].imageUrl.toString() : "";
                                          });
                                          if ( userData!.posts![index]!.postContents![0].totalLikeByHeart.toString() == "0") {
                                          } else {
                                            getLikePost( userData!.posts![index]!.postContents![0].postId!.toInt(),"1");
                                    ...
                                    GestureDetector(
                                      onTap: () {
                                        setState(() {
                                          if( userData!.posts![index]!.postContents![0].currentUserLikeByThumb=="1"){
                                            userData!.posts![index]!.postContents![0].currentUserLikeByThumb="0";
                                            feedPresenter?.doLikePost( userData!.posts![index]!.id.toString(), false, "0");
                                          }else{
                                            userData!.posts![index]!.postContents![0].currentUserLikeByThumb="1";
                                            userData!.posts![index]!.postContents![0].currentUserLikeByHeart="0";
                                            userData!.posts![index]!.postContents![0].currentUserLikeByStar="0";
                                            feedPresenter?.doLikePost( userData!.posts![index]!.postContents![0].postId.toString(), true, "0");
                                          }
                                    ...
                                    GestureDetector(
                                        onTap: (){
                                          setState(() {
                                            ...
                                            postDate =  userData!.createdAt.toString();
                                            postID =  userData!.posts![index].postContents![0].postId.toString();
                                            // userProfile = userData!.posts![index]!.post!.user!.userImagesWhileSignup!.isNotEmpty ? allPosts[index]!.user!.userImagesWhileSignup![0].imageUrl.toString() : "";
                                          });
                                          if ( userData!.posts![index]!.postContents![0].totalLikeByThumb.toString() == "0") {
                                          } else {
                                            getLikePost( userData!.posts![index]!.postContents![0]!.postId!.toInt(),"0");
                                    ...
                                    GestureDetector(
                                        onTap: () {
                                          setState(() {
                                            if( userData!.posts![index]!.postContents![0].currentUserLikeByStar=="1"){
                                              userData!.posts![index]!.postContents![0].currentUserLikeByStar="0";
                                              feedPresenter?.doLikePost( userData!.posts![index]!.postContents![0]!.id.toString(), false, "2");
                                            }else{
                                              userData!.posts![index]!.postContents![0].currentUserLikeByStar="1";
                                              userData!.posts![index]!.postContents![0].currentUserLikeByHeart="0";
                                              userData!.posts![index]!.postContents![0].currentUserLikeByThumb="0";
                                              feedPresenter?.doLikePost( userData!.posts![index]!.postContents![0]!.postId.toString(), true, "2");
                                            }
                            ...
                            GestureDetector(
                              onTap:
                                ...
                                setState(() {
                                  ...
                                  postID =  userData!.posts![index].postContents![0].postId.toString();
                                  userProfile =
                                  userData!.userImagesWhileSignup!.isNotEmpty ?
                                  userData!.userImagesWhileSignup![0].imageUrl.toString() : "";
                                });
                                getcommentPost(userData!.posts![index].postContents![0].postId.toString());
                              },
                            ...
                            GestureDetector(
                              onTap: (){
                                setState(() {
                                  ...
                                  postDate =   userData!.createdAt.toString();
                                  postID =   userData!.posts![index]!.postContents![0].postId.toString();
                                  // userProfile =  userData!.posts![index]!.post!.user!.userImagesWhileSignup!.isNotEmpty ?  userData!.posts![index]!.post!.user!.userImagesWhileSignup![0].imageUrl.toString() : "";
                                });
                                if (  userData!.posts![index]!.postContents![0].totalTagsOnThisPost.toString() != "0") {
                                  setState(() {
                                    postID =  userData!.posts![index]!.postContents![0].postId!.toString();
                              ...
                              child: Container(
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      const Gap(4),
                                      Utils.mediumHeadingNormalText(text: "${  userData!.posts![index]!.postContents![0].totalTagsOnThisPost.toString()} Tags", textSize: 10, color: HexColor("#7B7F91")),
                                      const Gap(6),
                                      Image.asset(
                                        "assets/images/icon_down.png",
                                        height: 10,
