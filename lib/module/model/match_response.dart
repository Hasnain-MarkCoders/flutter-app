class MatchResponse {
  ...
  MatchResponse({this.status, this.data, this.message});
...
class MatchData {
  ...
  MatchData.fromJson(Map<String, dynamic> json) {
    ...
    if (json['user_data'] != null) {
      userData = <UserDataMatch>[];
      json['user_data'].forEach((v) {
        userData!.add(new UserDataMatch.fromJson(v));
      });
    }
  }
...
class UserDataMatch {
  ...
  UserDataMatch.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    userId = json['user_id'];
    ...
    partnerData = json['partner_data'] != null
        ? new PartnerData.fromJson(json['partner_data'])
        : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.partnerData != null) {
      data['partner_data'] = this.partnerData!.toJson();
    }
    return data;
  }
}
...
class PartnerData {
  ...
  String? characterAmDependableAndReliable;
  String? characterAttractionInRelationship;
  String? characterAmRebelNeverDoThingsNorma;
  String? characterCannotDateBelowMySocioEco;
  String? characterIDontCareWhatPeopleSayAb;
  String? characterAmOutgoingAndMakeAnywhere;
  String? chooseAnyOne;
  bool? floorStatus;
  Verification? verification;
  String? country;
  ...
  PartnerData(
      {this.id,
        ...
        this.characterAmDependableAndReliable,
        this.characterAttractionInRelationship,
        this.characterAmRebelNeverDoThingsNorma,
        this.characterCannotDateBelowMySocioEco,
        this.characterIDontCareWhatPeopleSayAb,
        this.characterAmOutgoingAndMakeAnywhere,
        this.chooseAnyOne,
        this.floorStatus,
        this.verification,
        this.country,
  ...
  PartnerData.fromJson(Map<String, dynamic> json) {
    ...
    characterAttractionInRelationship =
    json['character_attraction_in_relationship'];
    characterAmRebelNeverDoThingsNorma =
    json['character_am_rebel_never_do_things_norma'];
    characterCannotDateBelowMySocioEco =
    json['character_cannot_date_below_my_socio_eco'];
    characterIDontCareWhatPeopleSayAb =
    json['character_i_dont_care_what_people_say_ab'];
    characterAmOutgoingAndMakeAnywhere =
    json['character_am_outgoing_and_make_anywhere_'];
    chooseAnyOne = json['choose_any_one'];
    floorStatus = json['floor_status'];
    verification = json['verification'] != null
        ? new Verification.fromJson(json['verification'])
  ...
  Map<String, dynamic> toJson() {
    ...
    data['character_attraction_in_relationship'] =
        this.characterAttractionInRelationship;
    data['character_am_rebel_never_do_things_norma'] =
        this.characterAmRebelNeverDoThingsNorma;
    data['character_cannot_date_below_my_socio_eco'] =
        this.characterCannotDateBelowMySocioEco;
    data['character_i_dont_care_what_people_say_ab'] =
        this.characterIDontCareWhatPeopleSayAb;
    data['character_am_outgoing_and_make_anywhere_'] =
        this.characterAmOutgoingAndMakeAnywhere;
    data['choose_any_one'] = this.chooseAnyOne;
    data['floor_status'] = this.floorStatus;
    if (this.verification != null) {
...
class Subscriptions {
  ...
  dynamic appleSupscriptionGroupI;
  String? originalTransactionId;
  dynamic transactionId;
  String? platform;
  String? purchaseType;
  String? supscriptionType;
  dynamic currentInAppPurchaseStat;
  String? subscriptionCode;
  String? currentStatus;
  String? customerCode;
  String? subscriptionValidationSt;
  String? createdAt;
  String? updatedAt;
  ...
  Subscriptions(
      {this.id,
        ...
        this.appleSupscriptionGroupI,
        this.originalTransactionId,
        this.transactionId,
        this.platform,
        this.purchaseType,
        this.supscriptionType,
        this.currentInAppPurchaseStat,
        this.subscriptionCode,
        this.currentStatus,
        this.customerCode,
        this.subscriptionValidationSt,
        this.createdAt,
        this.updatedAt});
  ...
  Subscriptions.fromJson(Map<String, dynamic> json) {
    ...
    appleSupscriptionGroupI = json['apple_supscription_group_i'];
    originalTransactionId = json['original_transaction_id'];
    transactionId = json['transaction_id'];
    platform = json['platform'];
    purchaseType = json['purchase_type'];
    supscriptionType = json['supscription_type'];
    currentInAppPurchaseStat = json['current_InAppPurchase_stat'];
    subscriptionCode = json['subscription_code'];
    currentStatus = json['current_status'];
    customerCode = json['customer_code'];
    subscriptionValidationSt = json['subscription_validation_st'];
    createdAt = json['createdAt'];
    updatedAt = json['updatedAt'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['apple_supscription_group_i'] = this.appleSupscriptionGroupI;
    ...
    data['current_InAppPurchase_stat'] = this.currentInAppPurchaseStat;
    data['subscription_code'] = this.subscriptionCode;
    data['current_status'] = this.currentStatus;
    data['customer_code'] = this.customerCode;
    data['subscription_validation_st'] = this.subscriptionValidationSt;
    data['createdAt'] = this.createdAt;
    data['updatedAt'] = this.updatedAt;
    return data;
  }
