class LikeShortResponse {
  int? status;
  LikeShortsData? data;
  String? message;

  LikeShortResponse({this.status, this.data, this.message});

  LikeShortResponse.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    data = json['data'] != null ? new LikeShortsData.fromJson(json['data']) : null;
...
class LikeShortsData {
  ...
  LikeShortsData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    ...
    if (json['likeDetails'] != null) {
      likeDetails = <LikeDetails>[];
      json['likeDetails'].forEach((v) {
        likeDetails!.add(new LikeDetails.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.likeDetails != null) {
      data['likeDetails'] = this.likeDetails!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class User {
  ...
  String? characterAmDependableAndReliable;
  String? characterAttractionInRelationship;
  String? characterAmRebelNeverDoThingsNormal;
  String? characterCannotDateBelowMySocioEcon;
  String? characterIDontCareWhatPeopleSayAbo;
  String? characterAmOutgoingAndMakeAnywhereE;
  String? chooseAnyOne;
  bool? floorStatus;
  Verification? verification;
  String? country;
  ...
  User(
      {this.id,
        ...
        this.characterAmDependableAndReliable,
        this.characterAttractionInRelationship,
        this.characterAmRebelNeverDoThingsNormal,
        this.characterCannotDateBelowMySocioEcon,
        this.characterIDontCareWhatPeopleSayAbo,
        this.characterAmOutgoingAndMakeAnywhereE,
        this.chooseAnyOne,
        this.floorStatus,
        this.verification,
        this.country,
  ...
  User.fromJson(Map<String, dynamic> json) {
    ...
    characterAttractionInRelationship =
    json['character_attraction_in_relationship'];
    characterAmRebelNeverDoThingsNormal =
    json['character_am_rebel_never_do_things_normal'];
    characterCannotDateBelowMySocioEcon =
    json['character_cannot_date_below_my_socio_econ'];
    characterIDontCareWhatPeopleSayAbo =
    json['character_i_dont_care_what_people_say_abo'];
    characterAmOutgoingAndMakeAnywhereE =
    json['character_am_outgoing_and_make_anywhere_e'];
    chooseAnyOne = json['choose_any_one'];
    floorStatus = json['floor_status'];
    verification = json['verification'] != null
        ? new Verification.fromJson(json['verification'])
  ...
  Map<String, dynamic> toJson() {
    ...
    data['character_attraction_in_relationship'] =
        this.characterAttractionInRelationship;
    data['character_am_rebel_never_do_things_normal'] =
        this.characterAmRebelNeverDoThingsNormal;
    data['character_cannot_date_below_my_socio_econ'] =
        this.characterCannotDateBelowMySocioEcon;
    data['character_i_dont_care_what_people_say_abo'] =
        this.characterIDontCareWhatPeopleSayAbo;
    data['character_am_outgoing_and_make_anywhere_e'] =
        this.characterAmOutgoingAndMakeAnywhereE;
    data['choose_any_one'] = this.chooseAnyOne;
    data['floor_status'] = this.floorStatus;
    if (this.verification != null) {
