...
class CommonPasswordSetting extends StatefulWidget {
  String ? hint;
  Color? bordercolor;
  TextEditingController ? controller;
  CommonPasswordSetting({Key? key,this.hint,this.controller,this.bordercolor}) : super(key: key);

  @override
  State<CommonPasswordSetting> createState() => _CommonPasswordState();
}

class _CommonPasswordState extends State<CommonPasswordSetting> {
     ...
     /* width:  Responsive().getResponsiveValue(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
            contentPadding: EdgeInsets.only(left: 16,top:6),
